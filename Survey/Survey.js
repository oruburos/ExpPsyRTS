                ...
                questions: [
                    {
                            ...
                            
                        {
                            ...
                            html:
                                ...
                                "There are <b>5 explorer units</b> under your command. You will have an opportunity to direct them to particular locations in the scene, and their job is to collect resources and take them back to the base. <br>" +
                                "<b>There’s a chance that another participant is competing for resources in the environment or playing as a predator, so take this into account!!!</b>"
                             +"        <h4>Objective</h4>" +"The aim of the game is to <b>collect as many resources as possible</b>, and each resource that you bring back to base camp will be converted to money; this only applies to the main, and not the practice session.<br>" +
                                    ...
                                    "One thing to bear in mind: on some occasions, though not always, you might encounter <b>participants controlling an alien or two</b>. Your units are not equipped with combat mode, so they will not be able to fight. " +
                                "<b>Also, you might find that another participant is directing another scientific team and is likely to have sent their explorer units to collect resources, so they will be trying to collect from the same resources that you are aiming to collect.</b>" +
                                    "Keep in mind that the alien planet is large, and there will be other resources that could be collected elsewhere. \n"
+
                                    "<h4>Controls</h4><b>Left-Click:</b> To direct them, all you need to do is move the mouse over the explorer (you can select more than one at a time, or all 5) and left-click. <br/>" +
